...
use crate::{objects::AABB, ray::Ray, Hittables, Interval, ScatterMaterials, Vec3};
...
mod test {
    ...
    use crate::{Lambertain, Metal, Sphere};
    ...
    fn test_bvh_from_hittable_list() {
        ...
        if let Hittables::Sphere(ref sphere) = *bvh.left.unwrap().left.unwrap().hittable.unwrap() {
            ...
            assert!(matches!(*sphere.material, ScatterMaterials::None))
        }
    }
    #[test]
    fn test_bvh_hit() {
