...
use rust_simple_raytracer::{
    construct_planar_quad_box, objects::Quad, Camera, CameraParams, Dielectric, Diffuse,
    HittableWithBBox, Image, Lambertain, Materials, Metal, Rotation, SolidColor, Sphere,
    Translation, Vec3, Vec3Axis, BVH,
};
